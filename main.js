...
tryAgain.addEventListener('click', handleClickReset)
...
function pickFortune() {
  ...
  let randomMessage = Math.floor(Math.random() * allFortunes)
  screen2.querySelector("h2").innerText = `${fortune[randomMessage]}`
}
